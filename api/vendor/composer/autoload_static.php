...
class ComposerStaticInitc0d20e9d3c08988720ab823eb6807ee4
{
    ...
    public static $classMap = array (
        'AdminGroup' => __DIR__ . '/../..' . '/models/admingroup.php',
        'AdminGroupController' => __DIR__ . '/../..' . '/controllers/admingroupcontroller.php',
        'AdminSession' => __DIR__ . '/../..' . '/models/adminsession.php',
        'AdminSessionController' => __DIR__ . '/../..' . '/controllers/adminsessioncontroller.php',
        'AdminUser' => __DIR__ . '/../..' . '/models/adminuser.php',
        'AdminUserController' => __DIR__ . '/../..' . '/controllers/adminusercontroller.php',
        'ApplicationLevel' => __DIR__ . '/../..' . '/config/appication.level.php',
        'Article' => __DIR__ . '/../..' . '/models/article.php',
        'ArticleController' => __DIR__ . '/../..' . '/controllers/articlecontroller.php',
        'ArticleTag' => __DIR__ . '/../..' . '/models/articletag.php',
        'ArticleTagController' => __DIR__ . '/../..' . '/controllers/articletagcontroller.php',
        'CRUD' => __DIR__ . '/../..' . '/controllers/interfaces/crud.php',
        ...
        'EBController' => __DIR__ . '/../..' . '/controllers/EBController.php',
        'EasyPeasyICS' => __DIR__ . '/..' . '/phpmailer/phpmailer/extras/EasyPeasyICS.php',
        'Email' => __DIR__ . '/../..' . '/libs/email.php',
        'EmailQueue' => __DIR__ . '/../..' . '/models/emailqueue.php',
        'ErrorLevel' => __DIR__ . '/../..' . '/libs/logger.php',
        'Eventbrite' => __DIR__ . '/../..' . '/libs/eventbrite.php',
        'File_Iterator' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Iterator.php',
        'File_Iterator_Facade' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Facade.php',
        'File_Iterator_Factory' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Factory.php',
        'Forum' => __DIR__ . '/../..' . '/models/forum.php',
        'ForumAnswer' => __DIR__ . '/../..' . '/models/forumanswer.php',
        'ForumAnswerController' => __DIR__ . '/../..' . '/controllers/forumanswercontroller.php',
        'ForumAnswerVoter' => __DIR__ . '/../..' . '/models/forumanswervoter.php',
        'ForumAnswerVoterController' => __DIR__ . '/../..' . '/controllers/forumanswervotercontroller.php',
        'ForumCategory' => __DIR__ . '/../..' . '/models/forumcategory.php',
        'ForumCategoryController' => __DIR__ . '/../..' . '/controllers/forumcategorycontroller.php',
        'ForumController' => __DIR__ . '/../..' . '/controllers/forumcontroller.php',
        'ForumVoter' => __DIR__ . '/../..' . '/models/forumvoter.php',
        'ForumVoterController' => __DIR__ . '/../..' . '/controllers/forumvotercontroller.php',
        ...
        'LSS\\Array2XML' => __DIR__ . '/../..' . '/libs/Array2XML.php',
        'LSS\\XML2Array' => __DIR__ . '/../..' . '/libs/XML2Array.php',
        'Logger' => __DIR__ . '/../..' . '/libs/logger.php',
        ...
        'PassHash' => __DIR__ . '/../..' . '/libs/passhash.php',
        'ResetPasswordHistory' => __DIR__ . '/../..' . '/models/resetpasswordhistory.php',
        'ResetPasswordHistoryController' => __DIR__ . '/../..' . '/controllers/resetpasswordhistorycontroller.php',
        'Response' => __DIR__ . '/../..' . '/libs/response.php',
        ...
        'Skill' => __DIR__ . '/../..' . '/models/skill.php',
        'SkillController' => __DIR__ . '/../..' . '/controllers/skillcontroller.php',
        ...
        'UserCurrentPosition' => __DIR__ . '/../..' . '/models/usercurrentposition.php',
        'UserCurrentPositionController' => __DIR__ . '/../..' . '/controllers/usercurrentpositioncontroller.php',
        'UserEducation' => __DIR__ . '/../..' . '/models/usereducation.php',
        'UserEducationController' => __DIR__ . '/../..' . '/controllers/usereducationcontroller.php',
        'UserPastPosition' => __DIR__ . '/../..' . '/models/userpastposition.php',
        'UserPastPositionController' => __DIR__ . '/../..' . '/controllers/userpastpositioncontroller.php',
        'UserSession' => __DIR__ . '/../..' . '/models/usersession.php',
        'UserSessionController' => __DIR__ . '/../..' . '/controllers/usersessioncontroller.php',
        'UserSkill' => __DIR__ . '/../..' . '/models/userskill.php',
        'UserSkillController' => __DIR__ . '/../..' . '/controllers/userskillcontroller.php',
        'Utils' => __DIR__ . '/../..' . '/libs/utils.php',
        'Validate' => __DIR__ . '/../..' . '/libs/validate.php',
        'Webpage' => __DIR__ . '/../..' . '/models/webpage.php',
        'WebpageController' => __DIR__ . '/../..' . '/controllers/webpagecontroller.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitc0d20e9d3c08988720ab823eb6807ee4::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitc0d20e9d3c08988720ab823eb6807ee4::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInitc0d20e9d3c08988720ab823eb6807ee4::$prefixesPsr0;
            $loader->classMap = ComposerStaticInitc0d20e9d3c08988720ab823eb6807ee4::$classMap;
