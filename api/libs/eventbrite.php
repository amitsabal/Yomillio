...
class Eventbrite {
    ...
    function __call( $method, $args ) {
        ...
        if($resp){
            ...
            if( isset( $resp->error ) && isset($resp->error->error_message) ){
                //echo $resp->error->error_message;
               // throw new Exception( $resp->error->error_message );// Commented as it is giving error
            }
        }
        return $resp;
    }
    ...
    public static function ticketWidget( $evnt, $height='300px', $width='100%' ) {
